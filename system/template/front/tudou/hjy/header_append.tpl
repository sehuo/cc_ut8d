...
<body>
      ...
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <div class="" id="bs-example-navbar-collapse-2">
            <form class="navbar-form navbar-left" role="search" action="{$front_url}search" method="post">
    ...
    <ul class="nav nav-pills nav-justified">
      <li><a href="{poc_url url=video/show}">视频</a></li>
      <li><a href="{poc_url url=channel/index}">分类</a></li> 
      <li><a href="{poc_url url=playlist/index}">特辑</a></li>
      <li><a href="{poc_url url=special/index}">专题</a></li>
    </ul>
